      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <label className="text-xs text-gray-600">
            ...
            />
            개인정보수집에 동의합니다.{" "}
            <span className="text-main"> (필수)</span>
          </label>
        </div>
        <div>
          <label className="text-xs text-gray-600">
        ...
        <button
          type="submit"
          className="bg-main block rounded-lg px-[195px] my-4 text-white py-3"
        >
          회원가입
        </button>
        <button
          type="button"
          className="bg-gray-500 rounded-lg px-[195px] my-4 text-white py-3"
